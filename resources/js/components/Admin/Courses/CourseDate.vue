            ...
            <div class="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-4">
                <div class="w-full h-12 border-b flex justify-between">
                    <div class="flex align-middle content-center text-gray-600">
                        <div class="flex content-center items-center pl-4">
                            ...
                            <table class="table w-full">
                                ...
                                <tbody>
                                    <tr v-for="(reservation, i) in actualCourseDate.reservations" :class="{'bg-gray-200': i % 2 == 0}">
                                        <td class="border border-r-0 px-1 py-1 text-left"><a :href="'/admin/reservations/' + reservation.id">{{ reservation.source_code }}</a></td>
                                        ...
                                        <td class="border border-l-0">
                                            <div class="inline-flex w-full flex justify-end">
                                                <button v-show="reservation.status === 'APPROVED'" @click="showModal('complete-reservation-modal', () => { selectedReservation = reservation})" :class="{'bg-gray-100': i % 2 == 0, 'bg-gray-300': i % 2 != 0}" class="hover:bg-gray-400 text-gray-800 font-bold p-1 px-2 cursor-pointer">Dokončit</button>
                                                <button v-show="reservation.status === 'UNAPPROVED'" @click="showModal('reject-reservation-modal', () => { selectedReservation = reservation})" :class="{'bg-gray-100': i % 2 == 0, 'bg-gray-300': i % 2 != 0}" class="hover:bg-gray-400 text-gray-800 font-bold p-1 px-2 cursor-pointer">Zamítnout</button>
                                                <button v-show="reservation.status === 'UNAPPROVED'" @click="showModal('approve-reservation-modal', () => { selectedReservation = reservation})" :class="{'bg-gray-100': i % 2 == 0, 'bg-gray-300': i % 2 != 0}" class="hover:bg-gray-400 text-gray-800 font-bold p-1 px-2 cursor-pointer">Schválit</button>
                                                <button @click="showModal('delete-reservation-modal', () => { selectedReservation = reservation; })" :class="{'bg-gray-100': i % 2 == 0, 'bg-gray-300': i % 2 != 0}" class="hover:bg-gray-400 text-gray-800 font-bold p-1 px-2 cursor-pointer">Odstranit</button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
