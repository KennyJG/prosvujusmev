                ...
                <table class="table w-full">
                    ...
                    <tbody>
                        <tr v-for="(reservation, i) in reservations" :class="{'bg-gray-200': i % 2 == 0}">
                            ...
                            <td class="border border-r-0 px-4 py-2 text-left">{{ reservation.source_code }}</td>
                            <td class="border border-r-0 px-4 py-2 text-left">{{ reservation.status }}</td>
                            <td class="border px-4 py-2 text-left">{{ reservation.created_at }}</td>
                            <td class="border border-l-0 px-4 py-4 text-right">
                                <div class="inline-flex">
                                    ...
                                    <a @click="deleteReservation(reservation.id)" href="#" :class="{'bg-gray-100': i % 2 == 0, 'bg-gray-300': i % 2 != 0}" class="hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-r">
                                        Odstranit
                                    </a>
                                </div>
                            </td>
